...
7. Install ROOT (latest version 6.18) in your environment by doing
   - `conda install -c conda-forge root`
   - `conda install -c conda-forge/label/gcc7 root`
   - NOTE: We have tried to remove all ROOT dependencies for the machine learning analysis and see how far we can get.
